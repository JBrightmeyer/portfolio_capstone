...
class UserForm(FlaskForm):
    ...
    linkedin_url = StringField(
        "LinkedIn URL (optional)", validators=[URL(), Optional()]
    )
...
class ProjectForm(FlaskForm):
    ...
    owner_name = StringField(
        "Github Repository Owner Name", validators=[InputRequired()]
    )
    display_picture_url = StringField(
        "Display Picture URL (Optional)", validators=[URL(), Optional()]
    )
    github_url = StringField("Github URL (Optional)", validators=[URL(), Optional()])
